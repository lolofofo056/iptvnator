...
In **Settings → External player**, point IPTVnator at `IINA.app` (the bundle path, e.g. `/Applications/IINA.app`) where you would normally put the path to MPV or VLC. Streams open in IINA the same way they would in MPV — single instance, GUI controls included.
</Alert>
